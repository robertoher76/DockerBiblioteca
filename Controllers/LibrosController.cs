...
namespace DockerBiblioteca.Controllers
{
    public class LibrosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulo,FechaLanzamiento,AutorId,CategoriaId")] Libro libro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulo,FechaLanzamiento,AutorId,CategoriaId")] Libro libro)
        {
            ModelState.Remove("Autor");
            ModelState.Remove("Categoria");
            if (id != libro.Id)
